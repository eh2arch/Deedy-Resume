...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Archit}{Srivastava}{ \urlstyle{same}\href{http://github.com/eh2arch}{github.com/eh2arch}\\
\href{mailto:archits@usc.edu}{archits@usc.edu} | 323.649.0492
}
...
\location{May 2016 | Durgapur, India}
